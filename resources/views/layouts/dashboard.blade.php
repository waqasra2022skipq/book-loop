<x-layouts.app title="{{ $heading ?? 'Dashboard' }}">
        ...
        <flux:sidebar sticky stashable
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group expandable heading="My Books" class="lg:grid">
                    <flux:navlist.item :href="route('books.my-books')">My Books</flux:navlist.item>
                    <flux:navlist.item :href="route('books.create')">Add a Book</flux:navlist.item>
                    <flux:navlist.item :href="route('my-books.requests')">Requests</flux:navlist.item>
                </flux:navlist.group>
            </flux:navlist>
