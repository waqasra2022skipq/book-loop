<section class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
    ...
    <div class="relative w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div class="backdrop-blur-sm bg-white/80 rounded-3xl shadow-2xl border border-white/50 p-8 sm:p-12">
                <div class="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
                    ...
                    <div class="relative group">
                        <div class="absolute -inset-1 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 rounded-2xl blur opacity-75 group-hover:opacity-100 transition duration-500"></div>
                    ...
                    <div class="flex-1 text-center lg:text-left space-y-4">
                        <div class="space-y-2">
                            <h1 class="text-4xl sm:text-5xl lg:text-6xl font-black bg-gradient-to-r from-blue-700 via-purple-700 to-indigo-700 bg-clip-text text-transparent leading-tight">
                        ...
                        <div class="flex flex-wrap justify-center lg:justify-start gap-3 mt-6">
                            <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold bg-gradient-to-r from-emerald-500 to-green-600 text-white shadow-lg">
                                <div class="w-2 h-2 bg-white rounded-full mr-2 animate-pulse"></div>
                                {{ ucfirst($bookInstance->status) }}
                            </span>
                            <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold bg-gradient-to-r from-amber-500 to-orange-600 text-white shadow-lg">
        ...
        <div x-data="{ tab: 'detail' }" class="space-y-8">
            ...
            <div class="backdrop-blur-sm bg-white/70 rounded-2xl shadow-xl border border-white/50 p-2">
                <div class="flex flex-wrap justify-center gap-2">
                    <button @click="tab = 'detail'" 
                            :class="tab === 'detail' ? 'bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-lg scale-105' : 'text-gray-600 hover:text-gray-800 hover:bg-white/50'" 
                    ...
                    <button @click="tab = 'summaries'" 
                            :class="tab === 'summaries' ? 'bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-lg scale-105' : 'text-gray-600 hover:text-gray-800 hover:bg-white/50'" 
                            class="flex-1 sm:flex-none px-6 py-3 font-semibold rounded-xl transition-all duration-300 transform hover:scale-105 min-w-max">
                        <span class="flex items-center justify-center gap-2">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <button @click="tab = 'request'" 
                            :class="tab === 'request' ? 'bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-lg scale-105' : 'text-gray-600 hover:text-gray-800 hover:bg-white/50'" 
                            class="flex-1 sm:flex-none px-6 py-3 font-semibold rounded-xl transition-all duration-300 transform hover:scale-105 min-w-max">
                        <span class="flex items-center justify-center gap-2">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <button @click="tab = 'owner'" 
                            :class="tab === 'owner' ? 'bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-lg scale-105' : 'text-gray-600 hover:text-gray-800 hover:bg-white/50'" 
                            class="flex-1 sm:flex-none px-6 py-3 font-semibold rounded-xl transition-all duration-300 transform hover:scale-105 min-w-max">
                        <span class="flex items-center justify-center gap-2">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <!-- Tab Panels -->
            <div class="backdrop-blur-sm bg-white/80 rounded-3xl shadow-2xl border border-white/50 p-8 sm:p-12 min-h-96">
                <!-- Book Details -->
                    ...
                    <div class="grid sm:grid-cols-2 gap-6 pt-6 border-t border-gray-200">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <div class="text-lg font-semibold text-gray-800 capitalize">{{ $bookInstance->status }}</div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <div class="text-lg font-semibold text-gray-800">{{ $bookInstance->condition_notes }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div x-show="tab === 'owner'" 
                    ...
                    <div class="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-2xl p-8">
                        <div class="flex items-center gap-6">
                            <div class="relative">
                                <div class="w-20 h-20 rounded-full bg-gradient-to-r from-indigo-500 to-purple-600 flex items-center justify-center text-white font-bold text-2xl shadow-lg">
                            ...
                            <div class="space-y-2">
                                <div class="text-xl font-bold text-gray-800">{{ $bookInstance->owner->name }}</div>
