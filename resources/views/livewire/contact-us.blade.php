<section class="min-h-screen flex justify-center py-6 sm:py-12 px-3 sm:px-4">
    <div>
        <h1 class="text-2xl sm:text-3xl font-extrabold text-blue-700 mb-2">Contact Us</h1>
        <p class="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6 leading-relaxed">We value your feedback, suggestions,
            and questions. Please fill out the form below and we'll get back to you as soon as possible.</p>
        ...
        <form wire:submit.prevent="submit" class="space-y-4 sm:space-y-6">
            ...
            <div class="flex items-center justify-end">
                <flux:button variant="primary" type="submit" class="w-full text-sm sm:text-base py-2.5 sm:py-3">Send
                    Message</flux:button>
            </div>
        </form>
        <div class="mt-6 sm:mt-8 text-center text-gray-500 text-xs sm:text-sm">
            <p>We aim to respond to all queries within 24 hours.</p>
            <p class="mt-1">For urgent matters, please email <a href="mailto:contact@loopyourbook.com"
                    class="text-blue-600 underline">contact@loopyourbook.com</a></p>
        </div>
    </div>
</section>
